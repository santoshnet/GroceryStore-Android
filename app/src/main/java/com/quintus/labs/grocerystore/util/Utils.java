...
public class Utils {
    ...
    public static final String BannerImage = RestClient.BASE_URL + "assets/images/BannerImage/";
    public static final String OfferImage = RestClient.BASE_URL + "assets/images/OfferImage/";
