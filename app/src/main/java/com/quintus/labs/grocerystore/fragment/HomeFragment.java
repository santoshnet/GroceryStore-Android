...
import com.quintus.labs.grocerystore.model.Banner;
import com.quintus.labs.grocerystore.model.BannerResult;
import com.quintus.labs.grocerystore.model.Category;
import com.quintus.labs.grocerystore.model.CategoryResult;
import com.quintus.labs.grocerystore.model.Offer;
import com.quintus.labs.grocerystore.model.OfferResult;
import com.quintus.labs.grocerystore.model.Offers;
        ...
        call.enqueue(new Callback<OfferResult>() {
            ...
            public void onResponse(Call<OfferResult> call, Response<OfferResult> response) {
                if(response!=null){
                    ...
                    if(offerList.size()>1){
                        Picasso.get().load(Utils.OfferImage+offerList.get(0).getImage()).into(offer_image1);
                        Picasso.get().load(Utils.OfferImage+offerList.get(1).getImage()).into(offer_image2);
                    }
